...
const toolbarTexts = {
  en: {
    toggleSidebar: 'Toggle Sidebar (Cmd+Shift+B)',
    toggleTheme: 'Toggle Theme',
    aiFormat: 'AI Format Markdown (Cmd+Shift+F)',
    searchDocument: 'Search Document (Cmd+F)',
    documentOutline: 'Document Outline (Cmd+Shift+O)',
  ...
  zh: {
    ...
    toggleTheme: '切换主题',
    aiFormat: 'AI 格式化 Markdown (Cmd+Shift+F)',
    searchDocument: '搜索文档 (Cmd+F)',
    documentOutline: '文档大纲 (Cmd+Shift+O)',
